...
#include "TabWidgetFundations/CrioDirectAccessTestWidgets/QReadVoltageTestWidget.h"
...
class QCrioViewWidget : public QWidget
{
    ...
    Q_PROPERTY(QModulesIniListView *modulesListView READ modulesListView WRITE setModulesListView NOTIFY modulesListViewChanged)
...
public:
    explicit QCrioViewWidget(QString const &inifilePath, QWidget *parent = nullptr);
    ...
    QModulesIniListView *modulesListView();
    void setModulesListView(QModulesIniListView *newModulesListView);
...
public slots:
    ...
    void onFillChannelsWithModules (QComboBox *modulesCb,QComboBox *channelCb, int index);
